...
func TestNode_put(t *testing.T) {
	...
	n.put([]byte("baz"), []byte("baz"), []byte("2"), 0, 0, 0)
	n.put([]byte("foo"), []byte("foo"), []byte("0"), 0, 0, 0)
	n.put([]byte("bar"), []byte("bar"), []byte("1"), 0, 0, 0)
	n.put([]byte("foo"), []byte("foo"), []byte("3"), 0, leafPageFlag, 0)
...
func TestNode_write_LeafPage(t *testing.T) {
	...
	n.put([]byte("susy"), []byte("susy"), []byte("que"), 0, 0, 0)
	n.put([]byte("ricki"), []byte("ricki"), []byte("lake"), 0, 0, 0)
	n.put([]byte("john"), []byte("john"), []byte("johnson"), 0, 0, 0)
...
func TestNode_split(t *testing.T) {
	// Create a node.
	n := &node{inodes: make(inodes, 0), bucket: &Bucket{tx: &Tx{db: &DB{}, meta: &meta{pgid: 1}}}}
	n.put([]byte("00000001"), []byte("00000001"), []byte("0123456701234567"), 0, 0, 0)
	n.put([]byte("00000002"), []byte("00000002"), []byte("0123456701234567"), 0, 0, 0)
	n.put([]byte("00000003"), []byte("00000003"), []byte("0123456701234567"), 0, 0, 0)
	n.put([]byte("00000004"), []byte("00000004"), []byte("0123456701234567"), 0, 0, 0)
	n.put([]byte("00000005"), []byte("00000005"), []byte("0123456701234567"), 0, 0, 0)
